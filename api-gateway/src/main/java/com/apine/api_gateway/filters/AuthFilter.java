package com.apine.api_gateway.filters;

import com.apine.api_gateway.dtos.TokenDto;
...
public class AuthFilter implements GatewayFilter {
    ...
    private static final String ACCESS_TOKEN_HEADER_NANE = "accessToken";
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        return this.webClient
                ...
                .header(ACCESS_TOKEN_HEADER_NANE, token)
                .retrieve()
